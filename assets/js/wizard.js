document.addEventListener('DOMContentLoaded', function () {
  ...
  function updateWizardState(activeIndex) {
    ...
    // Update progress bar background color
    ...
    tabButtons.forEach(btn => {
      ...
      icon.className = 'wizard-step-icon rounded-circle p-3 mb-2';
    ...
    currentIcon.className = 'wizard-step-icon bg-primary-subtle rounded-circle p-3 mb-2';
    ...
    for (let i = 0; i < activeIndex; i++) {
      ...
      completedIcon.className = 'wizard-step-icon bg-success-subtle rounded-circle p-3 mb-2';
